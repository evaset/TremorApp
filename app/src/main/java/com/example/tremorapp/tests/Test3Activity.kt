...
import com.example.tremorapp.databinding.ActivityTest3Binding
    ...
    private fun setupTest() {
        ...
        binding.etInput.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                ...
                val currentTarget = targetSequences[currentSequenceIndex]

                // Determinar si fue inserción o borrado
                if (newText.length > lastText.length) {
                    // Carácter insertado - verificar si es correcto
                    val newChar = newText.last()
                    val expectedChar = currentTarget.getOrNull(newText.length - 1)
    ...
    private fun saveTestData() {
        try {
            ...
            val testData = JSONObject().apply {
                ...
                put("sequence", JSONArray(targetSequences))
